...
String getPosterUrl(String? path) {
  if (path != null && path.isNotEmpty) {
    return '${ApiConstants.basePosterUrl}$path'; // Concatenates the base URL with the path
  } else {
    return ApiConstants.moviePlaceHolder; // Returns a placeholder image URL
  }
}
...
String getAvatarUrl(String? path) {
  if (path != null) {
    if (path.startsWith('/https://www.gravatar.com/avatar')) {
      ...
      // ApiConstants.baseAvatarUrl + path;
    }
  } else {
    return ApiConstants.avatarPlaceHolder;
  }
...
// String getTrailerUrl(String tmdbID, bool isMovie) {
//   return isMovie
//       ? ApiConstants.basemovieVideoUrl + tmdbID
//       : ApiConstants.basetvVideoUrl + tmdbID;
// }
